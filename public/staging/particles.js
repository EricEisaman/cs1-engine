...
AFRAME.registerComponent('particles', {
    ...
    schema: {
       preset: {default: "fireworks"}           
    },
              
    init: function(){
      
      const blob = 'https://res.cloudinary.com/cs1/image/upload/v1592860992/blob_nt6ph0.png'
      const sparkle = 'https://cdn.glitch.com/12145dea-5884-48f3-897c-23efab722ce3%2Fsparkle.png?v=1588167898816'
      const explosion = 'https://res.cloudinary.com/cs1/image/upload/v1592860663/explosion_sheet_rt7f0b.png'
      const snowflake = 'https://res.cloudinary.com/cs1/image/upload/v1592908533/snow_hsqckq.png'
      ...
      size: 1, 2, 1, 0 
        ...
        greenBlob: `
        texture: ${blob}; 
        color: green; particle-count: 100; 
        maxAge: 1; 
        distribution: sphere; 
        velocity: .5; 
        acceleration: -1; 
        ...
        velocity: .4 .1 0; 
        acceleration: 0 2 0; 
        acceleration-spread: 0 2 0; 
        velocity-spread: .4 0 .4; 
        particle-count: 15; 
        max-age: 1; 
        size: 4,8; 
        size-spread: 2; 
        ...
        energyDisc:`
        texture: ${blob}; 
        particle-count: 300; maxAge: 1; 
        distribution: disc; 
        acceleration-distribution: box; 
        acceleration: 0 0 2; 
        color: orange
        `,
        vortex:`
        ...
        color: #ccc; 
        blending: normal; 
        position-spread: 10 0 10; 
        radius: 0; 
        randomize-position: true; 
        particle-count: 1500; 
        velocity: 0 -.6 0; 
        velocity-spread: .1 .2 .1; 
        wiggle-spread: 1 0 1; 
        maxAge: 16; 
        emitter-scale: 100
        `,
    ...
    update: function(){
      switch(this.data.preset){
        case 'greenBlob':
          ...
          s.setAttribute('color','lime')
          s.setAttribute('segments-width',8)
          s.setAttribute('segments-height',8)
          s.setAttribute('radius',1)
          this.el.appendChild(s)
          this.el.setAttribute("spe-particles", this.presets[this.data.preset]);
          break;
        case 'fire':
          this.el.setAttribute("spe-particles__sparks", this.presets.sparks);
          this.el.setAttribute("spe-particles__smoke", this.presets.smoke);
          this.el.setAttribute("spe-particles__flame", this.presets.flame);
          break;
        case 'energyDisc':
          const e = document.createElement('a-entity')
          e.setAttribute('rotation','-90 0 0')
          e.setAttribute("spe-particles", this.presets[this.data.preset]);
    ...
    AFRAME.registerPrimitive("cs1-particles",{
        defaultComponents: {
            particles: {}
          },
